function [I_MF, k_mean, k] = matched_filter_LCA(I, dev_std, length, resol, orient)
% MATCHED_FILTER Function used to implement the matched filter convolution
% for the low contrast and the artifact images.
